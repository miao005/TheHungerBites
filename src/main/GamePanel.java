...
public class GamePanel extends JPanel {
    ...
    public void setGameState(GameState newState) {
        // remember where we came from (useful for Settings back button)
        if (this.gameState != GameState.SETTINGS && this.gameState != GameState.CREDITS)
