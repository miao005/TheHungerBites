...
public class Jollibee extends Character {
    public Jollibee() {
        ...
        this.basicAttack = "Chicken Joy ni Sir Khai – Deals 16-22 damage";
        this.skillAttack = "Bee Swarm – Deals 24-32 damage";
        this.ultimateAttack = "Bida Ang Saya! – Deals 38-48 damage";
    }
    @Override public void basicAttack(Character target) { performAttack(target, 16, 22, 0, "Chicken Joy ni Sir Khai"); }
    @Override public void skillAttack(Character target) { performAttack(target, 24, 32, 30, "Bee Swarm"); }
